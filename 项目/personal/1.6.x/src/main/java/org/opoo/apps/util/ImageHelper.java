...
public class ImageHelper {
	...
	public static void saveImageAsJpg(String inFilePath, String outFilePath, int width, int hight, boolean proportion)
			throws Exception {
		StopWatch watch = new StopWatch("saveImageAsJpg");
		watch.start("read image");
	...
	public static void main(String[] args) throws Exception{
		ImageHelper.saveImageAsJpg("E:\\work.home\\usp44pfH.gif", "e:\\work.home\\a.jpg", 100, 60, true);
	}
}