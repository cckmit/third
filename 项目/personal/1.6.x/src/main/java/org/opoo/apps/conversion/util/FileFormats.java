...
import org.opoo.apps.conversion.ConversionException;
...
public class FileFormats
{
    ...
    public static int getNumberOfPages(File pdfContent) throws Exception {
    	//new BufferedInputStream(pdfDoc.getInputStream())
        InputStream fis = FileUtils.openInputStream(pdfContent);// .newFileInputStream(pdfContent);
        try {
