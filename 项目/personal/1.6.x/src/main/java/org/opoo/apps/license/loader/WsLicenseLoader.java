 ...
 */
public class WsLicenseLoader implements LicenseLoader {
...
//			log.debug("response: " + message);
	...
	public void startListen(final LicenseProvider provider) {
		...
		listenTimer = new Timer("WsLicenseLoader$ListenTimer");
	...
	public void stopListen() {
		if(listenTimer != null){
			try{
				log.debug("Cancel timer 'WsLicenseLoader$ListenTimer'.");
				listenTimer.cancel();
			}catch(Exception e){
				//ignore
			}
	...
	public static void main(String[] args){
		WsLicenseLoader loader = new WsLicenseLoader();
