...
public class AuthSSLProtocolSocketFactory implements SecureProtocolSocketFactory {
     ...
     */
	public AuthSSLProtocolSocketFactory(final URL keystoreUrl, final String keystorePassword, String keystoreType,
			final URL truststoreUrl, final String truststorePassword, String truststoreType) {
		super();
		this.keystoreUrl = keystoreUrl;
		this.keystorePassword = keystorePassword;
		this.truststoreUrl = truststoreUrl;
    ...
    private SSLContext createSSLContext() {
        try {
            ...
            if (this.truststoreUrl != null) {
                KeyStore keystore = createKeyStore(this.truststoreUrl, this.truststorePassword, this.truststoreType);
                if (LOG.isDebugEnabled()) {
                    Enumeration<String> aliases = keystore.aliases();
                    while (aliases.hasMoreElements()) {
                        String alias = (String)aliases.nextElement();
