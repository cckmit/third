...
%>
<p><div class="warn"><img src="images/warn-16x16.gif" width="16" height="16" border="0" alt="" />&nbsp;License 将于<%=format.format(ed)%>零时过期，请及时处理。</div></p>
<%		
	}else if(time <= 0){
		%>
...
//if(pm.getOnlineUserCount() > 0){
	...
	while(users.hasNext()){
		...
		out.println("<td>" + (pr.getStatus() == 0 ? "在线" : "离开") + "</td>");
