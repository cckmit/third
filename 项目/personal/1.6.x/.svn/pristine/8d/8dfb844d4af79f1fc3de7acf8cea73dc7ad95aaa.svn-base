...
import org.opoo.apps.lifecycle.ApplicationBak;
 ...
 * @since 1.5
 * @deprecated since 1.6.0, using SpringAppsContext
 */
public class SpringContext extends XmlWebApplicationContext implements AppsContext {
	...
	protected void finishRefresh() {
		super.finishRefresh();
		ApplicationBak.finishContextRefresh(this);
