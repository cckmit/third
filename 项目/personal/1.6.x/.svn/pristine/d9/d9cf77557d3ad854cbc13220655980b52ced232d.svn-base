/*
 *  $Id: HaspTime.java 13 2010-11-26 05:04:02Z alex $
 *
...
public class HaspTime {
	...
	private static native int DatetimeToHasptime(int day, int month, int year, int hour, int minute, int second,
			long time);

	private static native int HasptimeToDatetime(long time, int day[], int month[], int year[], int hour[],
