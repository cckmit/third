...
public class SimpleExample {
    ...
    public void run() throws Exception {
        ...
        JobDetail job2 = new JobDetail("job22222222222", "group1", HelloJob.class);
        SimpleTrigger trigger2 = new SimpleTrigger("trigger2", "group1", runTime);
        trigger2.setJobName("job22222222222");
        trigger2.setJobGroup(job2.getGroup());
        sched.addJob(job2, true);
        sched.scheduleJob(trigger2); 
        log.info(job2.getFullName() + " will run at: " + runTime); 
