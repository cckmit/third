 ...
 *
 */
public class MattersHandlerImpl extends AbstractMattersHandler implements MattersHandler {
	private static final Log log = LogFactory.getLog(MattersHandlerImpl.class);
	 ...
	 * 
	 */
	protected void processWorkAffair(Work work, Long bizId, Byte bizAction, RFSObject object, short tag, String note, WorkScheme ws/*List<RFSItemable> relatedItems*/) {
